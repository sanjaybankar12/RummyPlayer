...
<html>
	<head>
		...
		<script src="${pageContext.request.contextPath}/resources/js/skel-panels.min.js"></script>
		<script src="${pageContext.request.contextPath}/resources/js/init.js"></script>

		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/skel-noscript.css" />
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/style.css" />
		<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/style-desktop.css" />
	...
	<body class="homepage">
		...
		<div id="header">
			<div class="container">
				...
				<nav id="nav">
					<ul>
						<li class="active"><a href="${pageContext.request.contextPath}/home">Homepage</a></li>
